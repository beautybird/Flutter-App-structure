                  ...
                  child: Column(
                    children: [
                      ...
                      StandardFormTextField(
                        ...
                        obsecureText: false,
                        hintText:
                            'generalUse-emailToLoginOrSignup'.tr().toString(),
                        maxLines: 1,
                        formTextFieldLabel:
                            ...
                            await supabaseClient.auth
                              ...
                              if (signInResponse.user!.email!
                                ...
                                Timer(Duration(seconds: 2),
                                    () => context.go('/b/productsFormRoute'));
                              } else {
                                //
                                setState(() {
                                  _emailController.clear();
                                ...
                                Flushbar(
                                  ...
                                  title: 'generalUse-loggedin'.tr().toString(),
                                  titleColor: Colors.red,
                                  titleSize: 20.0,
                                  message:
                                      'generalUse-youLoggedIn'.tr().toString(),
                                  messageColor: Colors.black,
                                  messageSize: 16.0,
                                  messageText: Text(
                                      'generalUse-youLoggedIn'.tr().toString()),
                                  titleText: Text(
                                    'generalUse-loggedin'.tr().toString(),
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      color: Colors.red,
                                      fontSize: 20.0,
                                ...
                                Timer(Duration(seconds: 2), () {
                                  context.go('/a/addBuyButtonsLoginRoute');
                                });
                              }
                ...
                SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        'generalUse-loginWithPhone'.tr().toString(),
                        textAlign: TextAlign.center,
                      ),
                    ),
                  ),
                ...
                SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        'generalUse-loginWithEmail'.tr().toString(),
                        textAlign: TextAlign.center,
                      ),
                    ),
                  ),
