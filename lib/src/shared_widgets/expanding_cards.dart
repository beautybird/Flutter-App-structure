...
class ExpandingCardsPage extends StatefulWidget {
  const ExpandingCardsPage({super.key});

  @override
  State<ExpandingCardsPage> createState() => _ExpandingCardsPageState();
}

class _ExpandingCardsPageState extends State<ExpandingCardsPage> {
